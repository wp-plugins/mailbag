...
/*
Plugin Name: Mailbag
Plugin URI: http://themes.okaythemes.com/mailbag
Description: Add MailChimp or Campaign Monitor email forms with a shortcode.
Version: 1.0
...
function mailbag_add_options_page() {
	...
	$mailbag_options = add_options_page( __( 'Mailbag Settings', 'mailbag' ), __( 'Mailbag Settings', 'mailbag' ), 'manage_options', __FILE__, 'mailbag_render_form' );
}
					...
					<div class="settings-field">
						<div class="inside">
							...
							<div class="setting">
								...
								<p><?php _e('Once you have entered your keys and chosen a subscription list, you can add the form to any of your posts or pages with a shortcode.','mailbag'); ?></p>
	...
	if(strlen(trim($mailbag_options['mailchimp_api'])) > 0 ) { ?>
		...
		<form id="mailbag_mailchimp" class="mailbag-wrap" action="" method="post">
			<div class="mailbag-input">
				<label for="mailbag_mailchimp_email"><?php _e('Enter your email:', 'mailbag'); ?></label><br/>
				<input name="mailbag_mailchimp_email" id="mailbag_mailchimp_email" type="email"/>
			</div>
			<div class="mailbag-input">
	...
	ob_start(); 
		if(isset($_GET['submitted']) && $_GET['submitted'] == 'yes') {
			...
			<form id="mailbag_campaign_monitor" class="mailbag-wrap" action="" method="post">
				<div class="mailbag-input">
					<label for="mailbag_cm_name"><?php _e('Enter your name:', 'mailbag'); ?></label><br/>
					<input name="mailbag_cm_name" id="mailbag_cm_name" type="text"/>
				</div>			
				<div class="mailbag-input">
					<label for="mailbag_cm_email"><?php _e('Enter your email:', 'mailbag'); ?></label><br/>
					<input name="mailbag_cm_email" id="mailbag_cm_email" type="text"/>
				</div>
				<div class="mailbag-input">
					<input type="hidden" name="redirect" value="<?php echo $redirect; ?>"/>
